...
.invalid:before {
 ...
 <div class="main">
        ...
        <form id="register" action="register.php" method="POST">    
            ...
            <span id="password-eye" onclick="togglePasswordVisibility()" style="cursor: pointer; " >👁️</span>
            <br><br>
            <label for="confirmpassword">Confirm Password : </label>
            <br>
            <input type="password" name="cpass" 
            id="cpsw" placeholder="Renter the password" required>
            <span id="password-eye" onclick="togglecPasswordVisibility()" style="cursor: pointer; "  >👁️</span>
            <br><br>
...
function togglecPasswordVisibility() {
  ...
  const type = passwordInput.type === 'password' ? 'text' : 'password';
  passwordInput.type = type;
  passwordEye.innerHTML = type === 'cpsw' ? '👁️' : '👁️';
}
</script>
</body>
</html>